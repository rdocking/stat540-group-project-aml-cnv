...
stripplot(gExp ~ trisomy_8 | intersection[1:9] , prepareData(intersection[1:9], t(data), (des)), jitter.data = TRUE, auto.key = TRUE, type = c('p', 'a'), grid = TRUE, main= "Interesting hits")
